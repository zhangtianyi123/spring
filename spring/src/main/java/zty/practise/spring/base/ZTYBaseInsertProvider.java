...
public class ZTYBaseInsertProvider extends BaseInsertProvider {

	public ZTYBaseInsertProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
    ...
    public String insertIgnore(MappedStatement ms) {
        ...
        sql.append(ZTYSqlHelper.insertIntoMysqlTable(entityClass, tableName(entityClass)));
